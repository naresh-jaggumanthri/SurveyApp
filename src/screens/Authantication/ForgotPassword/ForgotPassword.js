...
import { Button, ConfirmationAlert, Spacing, VectorIcon, Input, } from '../../../components';
        ...
        <View style={Logins.TabMinView}>
          <View>
            <View style={Logins.TabMinViewChild}>
               <Spacing space={SH(20)} />
              <TouchableOpacity style={Logins.ForgotBack} onPress={() => navigation.navigate(RouteName.LOGIN_SCREEN)}>
                <VectorIcon name="chevron-left" icon="Entypo" size={SF(29)} color={Colors.white_text_color} />
              </TouchableOpacity>
              <Spacing space={SH(20)} />
